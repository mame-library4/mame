...
private:
    ...
    struct TailChargeParticleConstants
    {
        DirectX::XMFLOAT4   tailPosition_[MaxTailNum_] = {};
        DirectX::XMFLOAT4   particleColor_ = { 1, 1, 1, 1 };
        float               particleSize_ = 0.02f;
    ...
    TailParticleConstants           tailParticleConstants_;
    TailChargeParticleConstants     tailChargeParticleConstants_;
